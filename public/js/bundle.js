...
var modalForm = document.querySelector('#create-form');
var saveBtn = document.querySelector('#save-btn');
if (projectCreateButton) {
  var existingModal = new bootstrap.Modal(modal);
  saveBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./projects":"projects.js"}],"index.js":[function(require,module,exports) {
"use strict";
