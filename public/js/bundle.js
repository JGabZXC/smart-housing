    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "/api/v1/projects?&page=".concat(currentPage, "&limit=").concat(projectsPerPage, "&sort=-date")
          });
        case 3:
          res = _context.sent;
...
function renderPagination(totalPages) {
  var pagination = document.querySelector('.pagination');
  pagination.innerHTML = '';
  var prevButton = "<li class=\"page-item ".concat(currentPage === 1 ? 'disabled' : '', "\">\n    <a class=\"page-link\" aria-label=\"Previous\" onClick=\"changeProjectPage(").concat(currentPage - 1, ")\">\n      <span aria-hidden=\"true\">\xAB</span>\n    </a>\n  </li>");
  pagination.innerHTML += prevButton;
  for (var i = 1; i <= totalPages; i++) {
    var pageItem = "<li class=\"page-item ".concat(i === currentPage ? 'active' : '', "\">\n      <a class=\"page-link\" onClick=\"changeProjectPage(").concat(i, ")\">").concat(i, "</a>\n    </li>");
    pagination.innerHTML += pageItem;
  }
  var nextButton = "<li class=\"page-item ".concat(!hasNextPage ? 'disabled' : '', "\">\n    <a class=\"page-link\" aria-label=\"Next\" onClick=\"changeProjectPage(").concat(currentPage + 1, ")\">\n      <span aria-hidden=\"true\">\xBB</span>\n    </a>\n  </li>");
  pagination.innerHTML += nextButton;
}
...
},{"axios":"../../node_modules/axios/index.js"}],"events.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "/api/v1/events?&page=".concat(currentPage, "&limit=").concat(projectsPerPage, "&sort=-date")
          });
        case 3:
          res = _context.sent;
