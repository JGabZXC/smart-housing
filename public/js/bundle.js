...
var bootstrapDeleteModal = new bootstrap.Modal(deleteElement);
var house;
var queryString = '';
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (sortParam) {
              queryString = "?sort=".concat(orderParam).concat(sortParam, "&"); // Add sort parameter with order prefix
            }
            if (limitParam) {
              queryString += "limit=".concat(limitParam, "&"); // Add limit parameter
            }
