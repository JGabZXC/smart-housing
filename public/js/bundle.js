...
},{"../utils/http.js":"utils/http.js"}],"Event/events.js":[function(require,module,exports) {
"use strict";
...
},{"../utils/http.js":"utils/http.js"}],"utils/alerts.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","../utils/alerts.js":"utils/alerts.js","../utils/spinner.js":"utils/spinner.js"}],"alerts.js":[function(require,module,exports) {
"use strict";
...
},{}],"payment.js":[function(require,module,exports) {
"use strict";
...
if (paymentForm) {
  paymentForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var from, to, fromMMYYYY, toMMYYYY, dateRange;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            from = fromDate.value; // e.g., "2024-06-01"
            to = toDate.value; // e.g., "2024-08-01"
            fromMMYYYY = from ? from.slice(5, 7) + from.slice(0, 4) : '';
            toMMYYYY = to ? to.slice(5, 7) + to.slice(0, 4) : '';
