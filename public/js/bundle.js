...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"utils/http.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.postData = exports.patchData = exports.fetchData = void 0;
...
var patchData = exports.patchData = /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              this.container.innerHTML = "<p class=\"fs-6 text-slate-400\">No ".concat(this.type, " available.</p>");
...
if (projectListContainer) {
  if (!projectList) projectList = new _PaginatedList.default({
...
},{"../utils/PaginatedList.js":"utils/PaginatedList.js"}],"utils/PaginatedAdminList.js":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _PaginatedList2 = _interopRequireDefault(require("./PaginatedList.js"));
var _http = require("./http.js");
var _spinner = require("./spinner.js");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var PaginatedAdminlist = /*#__PURE__*/function (_PaginatedList) {
  function PaginatedAdminlist(_ref) {
    var _this;
    var container = _ref.container,
      paginationContainer = _ref.paginationContainer,
      endpoint = _ref.endpoint,
      ...
      itemsPerPage = _ref$itemsPerPage === void 0 ? 1 : _ref$itemsPerPage,
      _ref$sort = _ref.sort,
      sort = _ref$sort === void 0 ? '_id' : _ref$sort;
    _classCallCheck(this, PaginatedAdminlist);
    _this = _callSuper(this, PaginatedAdminlist, [{
      container: container,
  ...
  _inherits(PaginatedAdminlist, _PaginatedList);
  return _createClass(PaginatedAdminlist, [{
    key: "createCard",
    value: function createCard(item) {
      var markup = "\n    <tr class=\"".concat(item.isFeatured ? 'table-success' : '', "\">\n      <td class=\"text-slate-800\" style=\"vertical-align: middle\">").concat(item.name, "</td>\n      <td class=\"text-slate-800\" style=\"vertical-align: middle;\">").concat(new Date(item.date).toLocaleString('en-PH', {
        month: 'long',
        day: 'numeric',
        year: 'numeric'
    ...
    value: function () {
      var _render = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _this2 = this;
        var data, items, totalPages, hasNextPage, featuredItem;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
            ...
            case 4:
              ...
              items = data.data.doc;
              totalPages = data.totalPages;
              hasNextPage = this.currentPage < totalPages; // For single data
              if (!items._id) {
                _context.next = 13;
                break;
              }
            ...
            case 16:
              if (this.currentPage === 1) {
                featuredItem = items.find(function (item) {
                  return item.isFeatured === true;
                });
                if (featuredItem) this.createCard(featuredItem);
              }
              items.forEach(function (item) {
                return !item.isFeatured && _this2.createCard(item);
              });
              if (totalPages > 1) this.renderPagination(totalPages, hasNextPage);
              _context.next = 25;
              break;
...
}(_PaginatedList2.default);
var _default = exports.default = PaginatedAdminlist;
},{"./PaginatedList.js":"utils/PaginatedList.js","./http.js":"utils/http.js","./spinner.js":"utils/spinner.js"}],"utils/alerts.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","../utils/alerts.js":"utils/alerts.js","../utils/spinner.js":"utils/spinner.js"}],"Event/events.js":[function(require,module,exports) {
"use strict";
...
},{"../utils/PaginatedList.js":"utils/PaginatedList.js"}],"utils/renderPagination.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","../utils/alerts.js":"utils/alerts.js","../utils/renderPagination.js":"utils/renderPagination.js","../utils/spinner.js":"utils/spinner.js","../utils/http.js":"utils/http.js"}],"Login/login.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","../utils/alerts.js":"utils/alerts.js","../utils/spinner.js":"utils/spinner.js"}],"Payment/payment.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("/api/v1/payments/payment-session", {
            method: 'POST',
            data: {
              dateRange: dateRange
            }
...
},{"axios":"../../node_modules/axios/index.js","../utils/alerts.js":"utils/alerts.js","../utils/spinner.js":"utils/spinner.js"}],"Me/me.js":[function(require,module,exports) {
"use strict";
...
var changePasswordFormButton = document.querySelector('#change-password-form-button');
var changeDetailsForm = document.querySelector('#change-details-form');
var changeDetailsFormButton = document.querySelector('#change-details-form-button');
if (changePasswordForm) {
  changePasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var formData, body, response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            ...
            _context.prev = 3;
            (0, _spinner.buttonSpinner)(changePasswordFormButton, 'Confirm', 'Loading');
            _context.next = 7;
            return (0, _http.patchData)("/api/v1/users/me/changePassword", body);
          case 7:
            response = _context.sent;
            if (response.status === 'success') {
          ...
          case 11:
            _context.prev = 11;
            _context.t0 = _context["catch"](3);
            (0, _alerts.showAlert)('error', _context.t0.response.data.message || 'An error occurred while changing the password.');
          case 14:
            _context.prev = 14;
            (0, _spinner.buttonSpinner)(changePasswordFormButton, 'Confirm', 'Loading');
...
if (changeDetailsForm) {
  changeDetailsForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var formData, body, response;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            formData = new FormData(e.target);
            body = {
              name: "".concat(formData.get('first-name'), " ").concat(formData.get('middle-initial'), " ").concat(formData.get('last-name')).trim(),
              email: formData.get('email') || ''
            };
            _context2.prev = 3;
            (0, _spinner.buttonSpinner)(changeDetailsFormButton, 'Confirm', 'Loading');
            _context2.next = 7;
            return (0, _http.patchData)("/api/v1/users/me/changeDetails", body);
          case 7:
            response = _context2.sent;
            if (response.status === 'success') {
              (0, _alerts.showAlert)('success', 'Details changed successfully!');
          ...
          case 11:
            ...
            (0, _alerts.showAlert)('error', _context2.t0.response.data.message || 'An error occurred while changing the details.');
          case 14:
            _context2.prev = 14;
            (0, _spinner.buttonSpinner)(changeDetailsFormButton, 'Confirm', 'Loading');
...
},{"../utils/spinner.js":"utils/spinner.js","../utils/http.js":"utils/http.js","../utils/alerts.js":"utils/alerts.js"}],"index.js":[function(require,module,exports) {
"use strict";
