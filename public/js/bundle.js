...
function _fetchData() {
  _fetchData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, container, renderFunction, currentPage, itemsPerPage, changePage) {
    var res, items, totalPages, hasNextPage;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
...
},{"axios":"../../node_modules/axios/index.js","./_eventAndProjHelper":"_eventAndProjHelper.js"}],"house.js":[function(require,module,exports) {
"use strict";
